...
4. In **System Settings**:
  a. Add *Amethyst* explicitly as a **Login Item** in **System Settings**
  b. Unselect *Automatically rearrange Spaces based on most recent use* under **Mission Control** panel in **Desktop & Dock**
  c. Set *Delay until repeat* to one notch to the left of *Short* in **Keyboard**
  d. Ensure *Switch to Desktop &lt;N&gt;* is enabled and mapped to *Alt-&lt;N&gt;* under **Mission Control** in **Keyboard Shortcuts** 
