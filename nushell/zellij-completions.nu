...
def "nu-complete zellij" [] {
  [
    ...
    { value: "delete-all-sessions", description: "Delete all sessions" },
    { value: "delete-session", description: "Delete a specific session" },
...
export extern "zellij delete-all-sessions" [
  --force(-f) # Kill the sessions if they're running before dleeting them
  --help(-h) # Print help information
